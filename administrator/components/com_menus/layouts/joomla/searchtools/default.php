		...
		<?php if(!empty($clientOptions)) : ?>
			<div class="btn-group mr-3" role="group">
				<?php foreach($clientOptions as $key => $option) : ?>
					<button type="button" class="js-stools-selector-btn btn <?php echo $defaultValue == $option->value ? 'btn-primary btn-outline' : 'btn-cancel'; ?>" value="<?php echo $option->value; ?>"><?php echo $option->text; ?></button>
				<?php endforeach; ?>
			</div>
