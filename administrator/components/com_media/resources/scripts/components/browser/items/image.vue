                ...
                <ul>
                    ...
                    <li>
                        <button type="button" class="action-rename" ref="actionRename" @keyup.enter="openRenameModal()"
                            ...
                            @focus="focused(true)" @blur="focused(false)" @keyup.esc="hideActions()"
                            @keyup.up="$refs.actionDownload.focus()" @keyup.down="canEdit ? $refs.actionEdit.focus() : $refs.actionShare.focus()" @click.stop="openRenameModal()">
                    ...
                    <li v-if="canEdit">
                        <button type="button" class="action-edit" ref="actionEdit"
                            ...
                            @focus="focused(true)" @blur="focused(false)" @keyup.esc="hideActions()"
                            @keyup.up="$refs.actionRename.focus()" @keyup.down="$refs.actionShare.focus()"  @click.stop="editItem()">
                            <span class="image-browser-action fa fa-pencil-alt" aria-hidden="true"></span>
                    ...
                    <li>
                        <button type="button" class="action-url" ref="actionShare" @keyup.enter="openShareUrlModal()"
                          ...
                          @focus="focused(true)" @blur="focused(false)" @keyup.esc="hideActions()"
                          @keyup.up="canEdit ? $refs.actionEdit.focus() : $refs.actionRename.focus()" @keyup.down="$refs.actionDelete.focus()" @click.stop="openShareUrlModal()">
