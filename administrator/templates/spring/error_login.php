...
// Enable assets
$wa->enableAsset('template.spring.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr'));
...
HTMLHelper::getServiceRegistry()->register('spring', 'JHtmlSpring');
HTMLHelper::_('spring.rootcolors', $this->params);
?>
<!DOCTYPE html>
	...
	<div class="logo-header">
		...
		<?php if (!$hiddenMenu): ?>
			<div class="sidebar-toggle d-none d-sm-block">
				<a id="menu-collapse" href="#" title="<?php echo Text::_('TPL_SPRING_TOGGLE_SIDEBAR'); ?>">
...
<div id="wrapper" class="d-flex wrapper">
	...
	<div id="sidebar-wrapper" class="sidebar-wrapper">
		<div id="main-brand" class="main-brand">
			...
			<a href="<?php echo Uri::root(); ?>"><?php echo Text::_('TPL_SPRING_LOGIN_SIDEBAR_VIEW_WEBSITE'); ?></a>
		</div>
		<div id="sidebar">
