...
abstract class JHtmlJGrid
{
	...
	)
	{
		...
		$states = array(
			...
			2 => array('unpublish', 'JARCHIVED', 'JLIB_HTML_UNPUBLISH_ITEM', 'JARCHIVED', true, 'fas fa-archive', 'archive'),
			-2 => array('publish', 'JTRASHED', 'JLIB_HTML_PUBLISH_ITEM', 'JTRASHED', true, 'fas fa-trash-alt', 'trash'),
		);
