...
?>
<div class="eb-mod-recent-post d-block d-md-flex align-items-md-center">
	<?php if ($params->get('photo_show', true) && $post->cover) { ?>
		<div class="eb-mod-recent-post-thumb position-relative">
	...
	<div class="eb-mod-recent-post-body">
		<?php if ($params->get('showcategory', true)) { ?>
			<div class="eb-mod-recent-post-categories">
				<?php foreach ($post->getCategories() as $category) { ?>
					<a class="eb-mod-recent-post-category" href="<?php echo $category->getPermalink();?>"><?php echo $category->getTitle(); ?></a>
				<?php } ?>
			</div>
		<?php } ?>

		<div class="eb-mod-recent-post-title">
			<a href="<?php echo $post->getPermalink(); ?>" title="<?php echo EB::themes()->escape($post->title); ?>"><?php echo $post->title;?></a>
		</div>

		<div class="eb-mod-recent-post-content">
			<?php if ($post->protect) { ?>
